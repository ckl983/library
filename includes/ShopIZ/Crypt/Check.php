...
class Check
{
    ...
    public static function crc16($text, $length = 0)
    {
        ...
        $uIndex = 0;
        for ($i = 0; $i < $length; $i++) {
            $uIndex = $uchCRCLo ^ ord(substr($text, $i, 1));
    ...
    public static function crc16_xmodem($text, $length = 0)
    {
        $length = ($length <= 0 ? strlen($text) : $length);
        $wCRCin = 0x0000;
        $wCPoly = 0x1021;
